 ...
 * @author Minh Hieu
 */
@WebServlet(name = "SupportAddServlet", urlPatterns = {"/supportadd"})
public class SupportAddServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(sdt.matches(phonePattern) == false){
            ...
            request.getRequestDispatcher("support_add.jsp").forward(request, response);
        }
        ...
        if(cccd.matches(identifyPattern) == false){
            ...
            dao.registerNHM(maTNV, tenTNV, gioiTinh, "", "", diaChi, sdt, cccd, matKhau);
        dao.registerTNV(maTNV, tenTNV, gioiTinh, diaChi, sdt, cccd, matKhau);
