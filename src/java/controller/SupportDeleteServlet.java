 ...
 * @author Minh Hieu
 */
@WebServlet(name = "SupportDeleteServlet", urlPatterns = {"/supportdelete"})
public class SupportDeleteServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String maTNV = request.getParameter("sid");
       DAO dao = new DAO();
       TNV_NHM d = dao.selectTNVbyMA(maTNV);
       String sdt = d.getSdt();
       NHM_TNV t = dao.selectNHM(sdt);
       String maNHM = t.getMaNHM();
