<%-- 
    Document   : support_add
    Created on : 22 Jun 2022, 09:05:29
    Author     : Minh Hieu
--%>
...
<html>
    ...
    <div class="login_container">
        <form action="supportadd" method="POST" class="login_form-input">
            <h2 class="login_title">Thêm mới Tình nguyện viên</h2>
            <div class="edit_input">
            <div class="left_input">
                <p style="color: red; font-size: 12px;">${all_err}</p>
                <input type="text" name="tenTNV" placeholder="Tên tình nguyện viên" required>
